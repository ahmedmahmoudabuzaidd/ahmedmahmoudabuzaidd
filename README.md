...
<h3 align="center">DevOps Engineer | Linux Admin | Cloud Enthusiast</h3>
...
- CI/CD using **Jenkins, GitHub Actions, Argo CD**  
- Containerization with **Docker**  
- Orchestration using **Kubernetes & OpenShift**  
- Infrastructure as Code using **Terraform**  
- Monitoring using **Prometheus & Grafana**  
- Configuration Management with **Ansible**

Currently expanding my skills in **AWS Cloud** to build scalable, secure, automated cloud environments.

---

## ⚡ Rapid Fire

- 💼 **Working on:** Deploying a 3-tier application on an OpenShift Cluster  
- 🌱 **Learning:** Deepening AWS Cloud expertise  
- 💬 **Ask me about:** Linux, Kubernetes, Docker, Ansible, Terraform, AWS, Monitoring  
- 🎢 **Fun fact:** *“I talk to servers more than people — and they’re usually nicer.”*  
- 📂 **Portfolio:**  
  👉 https://github.com/ahmedmahmoudabuzaidd
...
<img src="https://img.shields.io/badge/OpenShift-EE0000?logo=redhatopenshift&logoColor=white" height="28">
...
## 👀 Profile Views  
![Profile views](https://komarev.com/ghpvc/?username=ahmedmahmoudabuzaidd&label=Profile%20Views&color=blue&style=flat)
